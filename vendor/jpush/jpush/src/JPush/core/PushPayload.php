    ...
    public function addRegistrationId($registrationId) {
        ...
        if (is_array($registrationId)) {
            foreach($registrationId as $_registrationId) {
                ...
                if(strpos($_registrationId,',') !== false) //multi regId
                {
                    foreach(explode(',',$_registrationId) as $key=>$val)
                    {
                        if (!in_array($val, $this->registrationIds)) {
                            array_push($this->registrationIds, $val);
                        }
                    }
                }
                else if (!in_array($_registrationId, $this->registrationIds)) {

...
{
    var currentZ = $('#etextbook_kalaok').css('z-index');
    if(currentZ == 1005)
        $('#etextbook_kalaok').css('z-index','1000');
    else
        $('#etextbook_kalaok').css('z-index',parseInt(currentZ) +1);
...
var _processK = function (targetLines) {
	_etext = document.getElementById("etextbook_text");
    timers = [];

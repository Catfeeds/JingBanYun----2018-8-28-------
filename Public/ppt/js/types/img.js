    ...
    function buildMeidaList(mediaList) {
        ...
        mediaList.forEach(function (mid) {
            var li = $('<li class="span2"><a href="#" class="thumbnail"><img></a>' +
                '<p class="clearfix"><button class="btn pull-left" data-action="choose">选择</button>' +
    ...
    return {
                ...
                reader.onload = function (e) {
                    ...
                    if (src.length > 0) {
                        lib.minify(src, function (newSrc, info) {
                            localMedia = newSrc;
                            lib.embed(newSrc, localThumb, '图像加载错误!');
                        });
                    }
                };
        ...
        edit: function (key, page, data, dom) {
            ...
            if (!data.value) {
                ...
                lib.embed(data.value, urlThumb, '图像加载错误!');
                urlBtnRemove.show();
            }

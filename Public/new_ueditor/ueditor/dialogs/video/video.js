...
function setFileAccept(){   
    if($("#filePickerReady").find(':file').length==false){
        setTimeout("setFileAccept()",200);
    }else{
        $("#filePickerReady").find(':file').attr('accept','.mp4,.mp3,.mov');   
    }
}
setFileAccept();


function setPickerFileAccept(){     
    if($("#filePickerBlock").find(':file').length==false || $("#filePickerBtn").find(':file').length==false){
        setTimeout("setPickerFileAccept()",200);
    }else{
        $("#filePickerBlock").find(':file').attr('accept','.mp4,.mp3,.mov'); 
        $("#filePickerBtn").find(':file').attr('accept','.mp4,.mp3,.mov'); 
    }
}
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                ...
                $('#maxSize').text(Math.round(fileMaxSize/1024/1024));
            ...
            function addFile(file) {
                    ...
                    showError = function (code) {
                        switch (code) {
                            ...
                            default:
                                ...
                                //bind removeEvent to $info.text
                                $info.unbind().click(function(){uploader.removeFile(file)});
                                break;
                        }
                        $info.text(text).show();
                    };
                ...
                setPickerFileAccept();console.log(33);
            }

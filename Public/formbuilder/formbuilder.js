...
(function() {
  ...
  EditFieldView = (function(_super) {
    ...
    if(this.model.attributes.field_type=='牛顿力学'){
        buildNiuDun('n1')
    }
      return this;
    };
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        var attrs, _base;
        attrs = {};
        attrs[Formbuilder.options.mappings.LABEL] = '无标题';
    ...
    Formbuilder.options = {
      ...
      dict: {
        ...
        SAVE_FORM: '保存',
        UNSAVED_CHANGES: '您还没有保存，如果离开，您将丢失所有更改!'
      }
    };
...
(function() {
  Formbuilder.registerField('多行文本', {
    order: 5,
...
(function () {
    Formbuilder.registerField('牛顿力学', {
        order: 300,
        //type: 'non_input',
        view: "<p>牛顿力学实验模型</p><p id='n1'></p>",
        edit: "",
        addButton: "<span class='symbol'><span class='fa fa-minus'></span></span> 牛顿力学 "
    });

}).call(this);

(function() {
  Formbuilder.registerField('单行文本', {
    order: 0,
    view: "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />",
    edit: "<%= Formbuilder.templates['edit/size']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>",
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>格式</div>\n<label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
...
'\'\n  placeholder=\'为模板添加描述信息\'></textarea>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>大小</div>\n<select data-rv-value="model.' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>添加模板</a></li>\n    <li><a data-target=\'#editField\'>编辑模板</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content\'>\n    ' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-right\'>\n  <div class=\'fb-no-response-fields\'>没有响应的模板</div>\n  <div class=\'fb-response-fields\'></div>\n</div>\n';
...
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="复制模板"><i class=\'fa fa-plus-circle\'></i></a>\n  <a class="js-clear ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="删除模板"><i class=\'fa fa-minus-circle\'></i></a>\n</div>';

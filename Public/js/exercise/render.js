...
function renderExerciseLibraryChapter(chapterId, exercises1, callback) {
    $.get('index.php?m=Home&c=Admin&a=getExerciseLibraryChapterDetails', {id: chapterId}, function (res) {
        exercises = res;
        var html = [];

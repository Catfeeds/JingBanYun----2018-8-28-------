...
//BEGIN
    function createExerciseLibraryChapter_admin(chapterId, exercises1, callback) {      
    $.getJSON('index.php?m=Home&c=Admin&a=getExerciseLibraryChapterDetails', {id: chapterId}, function (res) {
        exercises = res;    
        var html = [];
        html.push('<div class="questionWrapper">');
        $(exercises).each(function (i, n) {
	...
	//BEGIN
    function createMyCollectExercise(exercises) {  
        //exercises = res;    
        var html = [];
        html.push('<div class="questionWrapper">');
        $(exercises).each(function (i, n) {	;
    ...
    //BEGIN
    function createExerciseCollect(id, exercises1, callback) { 
    $.getJSON('index.php?m=Home&c=Teach&a=getExerciseInfo', {id: id}, function (res) {
        exercises = res;    
        var html = [];
        html.push('<div class="questionWrapper">');
        $(exercises).each(function (i, n) {

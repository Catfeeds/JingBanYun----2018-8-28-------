...
(function(f) {
	...
	A.navigation = {
		...
		menuItemStyle: {
			...
			background: "none",
			color: "#303030",
			fontSize: H ? "14px" : "11px"   //14px  11px
		},
		menuItemHoverStyle: {
			background: "#4572A5",
			color: "#FFFFFF"
	...
	r(C.prototype, {
		...
		exportChart: function(a, b) {
			...
			f.post(a.url, {
				...
				type: a.type,
				width: a.width || 0,  //a.width
				scale: a.scale || 4,  //a.scale  
				svg: e
			}, a.formAttributes)
		},
		print: function() {
		...
		addButton: function(a) {
			...
			if (c.enabled !== !1) {
				...
				c.text && c.symbol ? o.paddingLeft = f.pick(o.paddingLeft, 25) : c.text || r(o, {
					width: c.width,
					height: c.height,
					padding: 0
				});

...
function SaveDoc(id, docType) {
    try {
        ...
        // 添加上传文件
        webObj.HttpAddPostString("name", myform.DocID.value);
        document.all.WebOffice1.HttpAddPostCurrFile("file","");
        // 提交上传文件
        returnValue = document.all.WebOffice1.HttpPost("http://123.56.145.63/api/teachermaterial.action.php/uploadLessonPlanning");


        //webObj.HttpAddPostCurrFile("DocContent", "");		// 上传文件
        //returnValue = webObj.HttpPost("http://123.56.145.63/api/fileupload.php");	// 判断上传是否成功

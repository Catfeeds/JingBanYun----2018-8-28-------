window._bd_share_main ? window._bd_share_is_recently_loaded = !0 : (window._bd_share_is_recently_loaded = !1, window._bd_share_main = {
	...
	var n = e("component/comm_tools"),
		...
		s = function (e) {
			e.bdUrl = window.bdUrl;
			e.bdPic = window.bdPic;
		...
		u = function (e, t) {
			...
			window.open(i, name, 'height=' + iHeight + ',,innerHeight=' + iHeight + ',width=' + iWidth + ',innerWidth=' + iWidth + ',top=' + iTop + ',left=' + iLeft + ', status=no, toolbar=no, menubar=no, location=no, resizable=no, scrollbars=0, titlebar=no'); 
		},
		a = function (e) {
			if (e) {
				var t = new RegExp("(^| )" + e + "=([^;]*)(;|$)"),

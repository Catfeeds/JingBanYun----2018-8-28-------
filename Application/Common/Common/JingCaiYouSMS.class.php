...
class JingCaiYouSMS
{
    ...
    private $appId          ="f6cfc47c01fa4bd9823a80aa78a285b4";   //开发者自己申请的应用ID
    private $jincaiyuntemplateId     ="258225";   //短信验证码模版ID
    ...
    public function templateSMS($to=null,$param=null,$type = 'json'){
        $result = $this->send($to,$this->appId,$this->jincaiyuntemplateId,$param,$type);
        return $result;
    }

...
* the License.
*/
namespace Common\Common\BaiduVoice;
...
class AipBase {
     ...
     * @var string
     */
    protected $appId = '10311749';

    /**
     * apiKey
     * @var string
     */
    protected $apiKey = 'PCbTLAOYac6qbGXATd3kdUZe';
    
    /**
     * secretKey
     * @var string
     */
    protected $secretKey = 'xepYBqXjfRnn02o2Hb4ZZS5sGHcOFDbx';

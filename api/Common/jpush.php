...
class Jpush{
    ...
    private $app_key = '3ffd867ec12d63f3d19b6212';            //待发送的应用程序(appKey)，只能填一个。
    private $master_secret = '2476e98931ec87db9ac3505a';        //主密码
    private $url = "https://api.jpush.cn/v3/push   //todo";      //推送的地址 TODO
    ...
    */
    ...
    public function push($receiver='all',$content='',$m_type='',$m_value='',$m_object='', $m_time='86400'){
        ...
        $data['notification'] = array(
            ...
            "android"=>array(
                ...
                "title"=>"",
                "builder_id"=>1,
                "extras"=>array("type"=>$m_type, "value"=>$m_value, "object"=>$m_object)
            ),
            //ios的自定义
            "ios"=>array(
                // "alert"=>$content,
